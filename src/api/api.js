...
let url = {
    ...
    debug: process.env.NODE_ENV !== 'development' ? true:false,  //true 后台接口 ， false 模拟接口
...
export const api = {
    ...
    'login': (url.debug ? url.staticPath + '/dataJson/login.json': url.staticPath + '/dataJson/login.json'),//登录模拟接口，正式环境请删除
